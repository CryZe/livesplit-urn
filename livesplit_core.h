...
extern GraphComponent GraphComponent_new(void);
extern void GraphComponent_drop(GraphComponent self);
extern char const* GraphComponent_state_as_json(GraphComponentRef self, TimerRef timer);
extern GraphComponentState GraphComponent_state(GraphComponentRef self, TimerRef timer);

extern void GraphComponentState_drop(GraphComponentState self);
extern size_t GraphComponentState_points_len(GraphComponentStateRef self);
extern float GraphComponentState_point_x(GraphComponentStateRef self, size_t index);
extern float GraphComponentState_point_y(GraphComponentStateRef self, size_t index);
extern size_t GraphComponentState_horizontal_grid_lines_len(GraphComponentStateRef self);
extern float GraphComponentState_horizontal_grid_line(GraphComponentStateRef self, size_t index);
extern size_t GraphComponentState_vertical_grid_lines_len(GraphComponentStateRef self);
extern float GraphComponentState_vertical_grid_line(GraphComponentStateRef self, size_t index);
extern float GraphComponentState_middle(GraphComponentStateRef self);
extern uint8_t GraphComponentState_is_live_delta_active(GraphComponentStateRef self);
...
extern Run Run_clone(RunRef self);
...
extern void SplitsComponent_set_visual_split_count(SplitsComponentRefMut self, size_t count);
extern void SplitsComponent_set_split_preview_count(SplitsComponentRefMut self, size_t count);
extern void SplitsComponent_set_always_show_last_split(SplitsComponentRefMut self, uint8_t always_show_last_split);
extern void SplitsComponent_set_separator_last_split(SplitsComponentRefMut self, uint8_t separator_last_split);
...
extern TextComponent TextComponent_new(void);
extern void TextComponent_drop(TextComponent self);
extern char const* TextComponent_state_as_json(TextComponentRef self);
extern TextComponentState TextComponent_state(TextComponentRef self);
extern void TextComponent_set_center(TextComponentRefMut self, char const* text);
extern void TextComponent_set_left(TextComponentRefMut self, char const* text);
extern void TextComponent_set_right(TextComponentRefMut self, char const* text);

extern void TextComponentState_drop(TextComponentState self);
extern char const* TextComponentState_left(TextComponentStateRef self);
extern char const* TextComponentState_right(TextComponentStateRef self);
extern char const* TextComponentState_center(TextComponentStateRef self);
extern uint8_t TextComponentState_is_split(TextComponentStateRef self);
...
extern void Timer_undo_all_pauses(TimerRefMut self);
...
extern TotalPlaytimeComponent TotalPlaytimeComponent_new(void);
extern void TotalPlaytimeComponent_drop(TotalPlaytimeComponent self);
extern char const* TotalPlaytimeComponent_state_as_json(TotalPlaytimeComponentRefMut self, TimerRef timer);
extern TotalPlaytimeComponentState TotalPlaytimeComponent_state(TotalPlaytimeComponentRefMut self, TimerRef timer);

extern void TotalPlaytimeComponentState_drop(TotalPlaytimeComponentState self);
extern char const* TotalPlaytimeComponentState_text(TotalPlaytimeComponentStateRef self);
extern char const* TotalPlaytimeComponentState_time(TotalPlaytimeComponentStateRef self);
